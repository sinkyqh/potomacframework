package agile.bundle
{
	 ...
	 * other than the one which served the main applications.  Currently, all Agile bundles are loaded into
	...
	public class BundleInstallDescriptor
	{
		 ...
		 * into your application.  Currently, all Agile bundles are loaded in the same ApplicationDomain and SecurityDomain.
