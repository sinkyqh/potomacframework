...
package agile.ui
{
	...
	[ExtensionPoint(id="Action", type="agile.ui.Action", declaredOn="classes", label="*string", icon="asset:png,gif,jpg")]
	[ExtensionPointDetails(id="Action", description="Declares a global Agile action")]
