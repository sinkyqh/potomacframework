...
package agile.ui
{
	...
	/**
	 * A reference to a part in a folder.  The part may or may not be created and its bundle may not yet be loaded.  Agile will attempt to
	 ...
	 * used), Agile will load any necessary bundles and create the part control.
	 */
