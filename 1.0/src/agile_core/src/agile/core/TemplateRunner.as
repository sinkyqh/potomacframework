...
package agile.core
{
	...
	/**
	 * Default application startup logic for Agile applications.  Creates the 
	...
	public class TemplateRunner extends LaunchRunner
	{
		...
		protected var _templateData:Object;
		protected var _injector:Injector;

		/**
		 * Called by the AgileInitializer (automatically generated code in the 
		 * application project).
		 * 
		...
		protected function onTemplateReady(e:InjectionEvent):void
		{					
			...
			var pUIClass:Class = getDefinitionByName("agile.ui.AgileUI") as Class;
