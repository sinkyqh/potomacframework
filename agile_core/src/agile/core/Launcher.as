...
package agile.core
{
	...
	public class Launcher
	{
		...
		private static var potomacPreloader:IAgilePreloader;
		...
		private static function findPotomacPreloader(container:DisplayObjectContainer):IAgilePreloader
		{			
			for (var i:int = 0; i < container.numChildren; i++) 
			{
				...
				else
				{
					...
					{
						var p:IAgilePreloader = findPotomacPreloader(container.getChildAt(i) as DisplayObjectContainer);
						if (p != null)
							return p;
					}
				}
		...
		public static function launch(manifest:LauncherManifest):void
		{
			...
			bundleService.agilePreloader = potomacPreloader;
