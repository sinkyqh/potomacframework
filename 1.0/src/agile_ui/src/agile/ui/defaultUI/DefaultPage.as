...
package agile.ui.defaultUI
{
	...
	import agile.ui.FolderFactory;
	import agile.ui.FolderOptions;
	import agile.ui.Page;
	import agile.ui.PageOptions;
	...
	public class DefaultPage extends Page
	{
		...
		[Inject]
		public function DefaultPage(folderFactory:FolderFactory, agileUI:AgileUI, bundleService:IBundleService, partExtensionMgr:PartExtensionManager)
		{
			super();
		...
		{
//			var storageID:String = "agile.ui.defaultUI.DefaultPage$" + id;
//			if (_agileUI.restoreLastOpened && _storageService.hasOwnProperty(storageID))
//			{
