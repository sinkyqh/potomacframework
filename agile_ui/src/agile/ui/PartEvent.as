...
package agile.ui
{
	...
	/**
	 * PartEvents are the main mechanism of communication between Parts and the Agile User Interface.  Some
	 * part events are sent from Agile to parts and some are sent from parts to Agile.  In both cases, the PartEvents
	...
	public class PartEvent extends Event
	{
		 ...
		 * <p>
		 * Dirty events are dispatched by parts to tell Agile that the part
		 * has unsaved changes.
		 * </p>
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 * <p>
		 * Clean events are dispatched by parts to tell Agile that the part no longer
		 * has unsaved changes.
		 * </p>
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 * <p>
		 * Busy events are dispatched by parts to tell Agile that the part is performing a long running activity,
		 * typically awaiting the results of a service call.  Agile will disable the part and show an animation.
		 ...
		 * <p>
		 * Idle events are dispatched by parts to tell Agile that the part is no longer
		 ...
		 * <p>
		 * Selection changed events are dispatched by parts to inform Agile that the
		 * selection in this part has changed.  Agile will in turn dispatch a SelectionEvent.SELECTION_CHANGED
		 * event to all parts.
		 * </p>
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 * <p>
		 * Do Save events are dispatched by Agile to parts when the user has requested the
		 ...
		 * <p>
		 * Save complete events are dispatched by parts to inform Agile that an
		 ...
		 * <p>
		 * Save error events are dispatched by parts to Agile when asynchronous
		...
		/**
		 * Sends an event to inform Agile that the part is busy.  Agile will disable the part and show an
		...
		/**
		 * Sends an event to inform Agile that the part is no longer busy.  If the part was busy, it will be re-enabled
		...
		/**
		 * Sends an event to inform Agile to in turn dispatch the given event on all parts.
		 *
		...
		/**
		 * Sends an event informing Agile that the given part is now dirty.
		 *
		...
		/**
		 * Sends an event informing Agile that the given part is now clean.
		 *
		...
		/**
		 * Sends an event informing Agile that the selection of the given part has changed.  Agile will
		...
		/**
		 * Sends an event informing Agile that the save on the given part was successful.
		 *
		...
		/**
		 * Sends an event informing Agile that the save on the given part did not complete as it
