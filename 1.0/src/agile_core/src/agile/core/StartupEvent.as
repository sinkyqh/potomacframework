package agile.core
{
	...
	{
		/**
		 * The StartupEvent.AGILE_INITIALIZED constant defines the value of the 
		 * <code>type</code> property of the event object 
		 * for a <code>agileInitialized</code> event.
		 * 
		 ...
		 *  </table>
		 *
		 * @eventType agileInitialized
		 */
		public static const AGILE_INITIALIZED:String = "agileInitialized";
		 ...
		 */
		public static const STARTUPLISTENER_COMPLETE:String = "agileStartupListenerComplete";
