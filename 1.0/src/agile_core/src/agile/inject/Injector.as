...
package agile.inject
{
	...
	import agile.bundle.Argument;
	import agile.bundle.BundleEvent;
	import agile.bundle.Extension;
	import agile.bundle.ExtensionEvent;
	...
	[ExtensionPoint(id="Injectable",access="public",declaredOn="classes",
					...
					providedBy="class:agile.inject.IProvider",singleton="boolean",asyncInit="boolean")]
	...
	[ExtensionPointDetails(id="InjectionListener",description="Marks a class as a Agile managed listener to all injection requests")]
	 ...
	 * </p>
	 * <p>
	 * The primary Agile injector is available for injection.  It is bound directly to Injector.
	 * </p>
	 * @author cgross
	 */
	public class Injector
	{
		 ...
		 * 
		 * @param bundleService The main Agile bundle service which the Injector will use to load bundles as necessary.
		 */
		 ...
		 * @private 
		 */
		Agile static function normalizeClassName(className:String):String
		{
		...
		internal function doBigNasty(clazz:Class,args:Array):Object
		{
			...
			if (args.length > 25)
				throw new Error("Agile only supports constructor injection with 25 parameters or less.");
